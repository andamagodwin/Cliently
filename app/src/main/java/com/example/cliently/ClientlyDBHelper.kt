...
class ClientlyDBHelper(context: Context) :
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        db.execSQL("INSERT INTO $TABLE_PRODUCTS ($COL_PROD_NAME, $COL_PROD_PRICE) VALUES ('Laptop Pro 15', 3500000)")
        db.execSQL("INSERT INTO $TABLE_PRODUCTS ($COL_PROD_NAME, $COL_PROD_PRICE) VALUES ('Wireless Mouse', 85000)")
        db.execSQL("INSERT INTO $TABLE_PRODUCTS ($COL_PROD_NAME, $COL_PROD_PRICE) VALUES ('USB-C Hub', 150000)")
        db.execSQL("INSERT INTO $TABLE_PRODUCTS ($COL_PROD_NAME, $COL_PROD_PRICE) VALUES ('Mechanical Keyboard', 450000)")
